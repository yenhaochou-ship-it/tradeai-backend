...
def build_dataset(api, symbols, days, stride=5, max_workers=5, use_cache=True):
...
def main():
    ...
    X, y, meta = build_dataset(api, symbols, args.days, args.stride, max_workers=args.workers, use_cache=not args.no_cache)
